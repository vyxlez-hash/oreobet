...
export const cryptoCurrencies = [
  { code: 'LTC' as const, name: 'Litecoin', icon: '₿', address: 'ltc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh' },
  { code: 'SOL' as const, name: 'Solana', icon: '◎', address: '7NQ41DNwBz9r9f4fQk3wLp2xH5vR8gK9mT' },
  { code: 'ETH' as const, name: 'Ethereum', icon: 'Ξ', address: '0x742d35Cc6634C0532925a3b844Bc454e4438f44e' },
];
